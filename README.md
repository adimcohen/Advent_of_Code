The idea is to solve the [Advant of Code 2022](https://adventofcode.com/2022) challenges using a single SQL Server T-SQL statement, implementing lessons leared from giants, the likes of Itzik Ben-Gan.
